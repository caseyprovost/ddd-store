...
module.exports = function (api) {
  ...
  return {
    presets: [isTestEnv && ['@babel/preset-env', {
      targets: {
        node: 'current'
      }
    ...
    plugins: ['babel-plugin-macros', '@babel/plugin-syntax-dynamic-import', isTestEnv && 'babel-plugin-dynamic-import-node', '@babel/plugin-transform-destructuring', ['@babel/plugin-proposal-class-properties', {
      loose: true
